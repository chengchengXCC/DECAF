...
extern int VMI_locate_module_byname_c(const char *name, /*uint32_t*/target_ulong pid,tmodinfo_t * tm);


extern int VMI_find_cr3_by_pid_c(/*uint32_t*/target_ulong pid);

extern int VMI_find_pid_by_cr3_c(/*uint32_t*/target_ulong cr3);
...
extern int VMI_find_process_by_cr3_c(/*uint32_t*/target_ulong cr3, char proc_name[], size_t len, /*uint32_t*/target_ulong *pid);
/* find process name and CR3 using the PID as search key  */
extern int VMI_find_process_by_pid_c(/*uint32_t*/target_ulong pid, char proc_name[], size_t len, /*uint32_t*/target_ulong *cr3);

extern int VMI_get_proc_modules_c(/*uint32_t*/target_ulong pid, /*uint32_t*/target_ulong mod_no, tmodinfo_t *buf);
...
extern int VMI_get_loaded_modules_count_c(/*uint32_t*/target_ulong pid);
//end - Aravind
...
extern int VMI_list_modules(Monitor *mon, /*uint32_t*/target_ulong pid);
